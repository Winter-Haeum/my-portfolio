...
const PROJECT_DETAILS = {
  WinterLog: {
    ...
    tagline: '학습 기록을 공유하고 질문·답변을 나누는 개발 학습 커뮤니티',
    intro: [
      '공부하면서 얻은 내용과 경험을 기록해 공유하고, 개발·학습 과정에서 생긴 질문을 서로 묻고 답할 수 있도록 만든 개발 학습 커뮤니티입니다.',
      '서비스 콘셉트와 사용자 흐름을 정리하고 게시글 작성·상세, 인증, 댓글, 카테고리·상태 태그 등 커뮤니티에 필요한 핵심 기능을 구현했습니다.',
    ],
    features: [
    ...
    scope: [
      '서비스의 사용자 흐름을 먼저 정리하고 게시글 작성·상세, 인증, 댓글 등 커뮤니티의 기본 흐름을 구현했습니다.',
